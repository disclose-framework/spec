...
|----------|-------------|
| [Specification](https://github.com/disclose-framework/spec) | Full specification: schema, attributes, attestations, verifier registry, governance, security, and versioning |
